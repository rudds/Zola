...
public class AfpRemote {
    ...
    public static void main(String[] args) {
    	try {
    		InetAddress address = InetAddress.getByName("133.101.57.78");
    		System.out.println(address);
    		
            System.out.println("Opening JmDNS...");
            JmDNS jmdns = JmDNS.create(address);
            System.out.println("Opened JmDNS!");
            System.out.println("getName: " + jmdns.getName());
            System.out.println("getName: " + jmdns.getHostName());
            ...
            ServiceInfo pairservice = ServiceInfo.create(REMOTE_TYPE, "murata", 80, 0, 0, "test of afp");
